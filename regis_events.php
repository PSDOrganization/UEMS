    ...
    <body>
        ...
        <table>
            ...
            <?php
                ...
                // Assuming email_id is the session variable set in stu_log.php
                if (isset($_SESSION['email_id'])) {
                    $emailid = $_SESSION['email_id'];
                } else {
                    // Handle the case when email_id is not set (redirect to login or do something else)
                ...
                WHERE participants.emailid = '$emailid'";
